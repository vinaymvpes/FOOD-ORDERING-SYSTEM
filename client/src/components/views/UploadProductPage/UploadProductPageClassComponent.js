...
const location = [
    { key: 1, value: "Electronic City" },
    { key: 2, value: "Koramangala" },
    { key: 3, value: "Whitefield" },
    { key: 4, value: "KR puram" },
    { key: 5, value: "Bhanshankari" },
    { key: 6, value: "Malleshwaram" },
    { key: 7, value: "Indiranagar" }
]
...
export class UploadProductPage extends Component {
    ...
    onSubmit = (event) => {
        ...
        if (!this.state.title || !this.state.description ||
            !this.state.location || !this.state.images
            || !this.state.price) {
        ...
        return (
            ...
            <Form onSubmit={this.onSubmit}>
               ...
               <FileUpload refreshFunction={this.updateFiles} />
                ...
                />
                <br /><br />
                <select onChange={this.handleChangelocation}>
                    {location.map(item => (
